...
public class SwipeManager : MonoBehaviour
{
    ...
    // Sustituye SwipeUpdate() con esto para pruebas con ratón
    void SwipeUpdate()
    {
        ...
        if (Input.GetMouseButton(0) && !m_endSwipe)
        {
            if (Vector2.Distance(m_startPos, Input.mousePosition) >= m_minDistance)
            {
